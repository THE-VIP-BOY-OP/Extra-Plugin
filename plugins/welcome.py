...
def welcomepic(user_id, chat_username, user_photo, chat_photo):
    ...
    user_img_circle = circle(user_img, size=(300, 300), brightness_factor=1.2)
    chat_img_circle = circle(chat_img, size=(300, 300), brightness_factor=1.2)
    
    background.paste(chat_img_circle, (200, 150), chat_img_circle)
    background.paste(user_img_circle, (900, 400), user_img_circle)
