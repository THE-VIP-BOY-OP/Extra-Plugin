...
def welcomepic(user_id, chat_username, user_photo, chat_photo):
    ...
    user_img_circle = circle(user_img, size=(280, 280), brightness_factor=1.2)
    chat_img_circle = circle(chat_img, size=(280, 280), brightness_factor=1.2)
    
    background.paste(chat_img_circle, (210, 120), chat_img_circle)
    background.paste(user_img_circle, (850, 350), user_img_circle)
